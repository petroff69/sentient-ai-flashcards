                ...
                >
                  ...
                  <div className="p-5">
                    {plan === "Free" ? (
                      <Link
                        href="/sign-in"
                        className={`bg-blue-700 px-4 py-2 rounded-lg w-full text-center text-white`}
                      >
                        Get Started
                      </Link>
                    ) : (
                      <button
                        className={cn(
                          ...
                          "w-full dark:bg-blue-700 dark:text-white dark:hover:bg-white dark:hover:text-black"
                        )}
