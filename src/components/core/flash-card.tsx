...
const formSchema = z.object({
    text: z.string().min(1, { message: "Text is required" }).max(2000, { message: "Text must be 2000 characters or less" }),
})
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-10 ">
            <Card className="w-full lg:max-w-[70vw] "> {/* Set max-w-xl for smaller screens */}
                <CardHeader className="flex flex-row items-center justify-between">
                    <CardTitle>Sentient AI Flashcard App</CardTitle>
                    {currentCard && (
                ...
                <CardContent>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-6 mb-4 space-y-2">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl className="border-blue-600">
                                            <Textarea
                                                id="text"
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-blue-700 dark:text-white hover:bg-blue-500"
                                disabled={loading}
                            >
                    ...
                    {flashcards.length > 0 && (
                        <>
                            <Button
                                variant="outline"
                                className="w-full text-white hover:text-white bg-blue-700 hover:bg-blue-500"
                            ...
                            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                                <DialogContent>
                                    ...
                                    <DialogFooter>
                                        <Button onClick={handleSaveSet} className="text-white hover:text-white bg-blue-700 hover:bg-blue-500">Save</Button>
                                    </DialogFooter>
                                </DialogContent>
                            </Dialog>
                        </>
            ...
            <Dialog open={saveSuccessDialogOpen} onOpenChange={setSaveSuccessDialogOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        }} className="text-white hover:text-white bg-blue-700 hover:bg-blue-500">
                            View Flashcards
                        </Button>
                    </DialogFooter>
                </DialogContent>
